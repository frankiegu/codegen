...
$yunpian_config_arr = Yaf_Registry::get("config")->yunpian_config->toArray();

$yunpian_config['APIKEY'] = $yunpian_config_arr['APIKEY'];

// php sdk 暂不支持加密算法
$yunpian_config['API_SECRET'] = $yunpian_config_arr['API_SECRET'];
