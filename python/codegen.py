...
class Generator:
    ...
    def gen_common(self):
        ...
        header_file = output_dir + '/views/header.html'
        ...
        nav_file = output_dir + '/views/nav.html'
        ...
        footer_file = output_dir + '/views/footer.html'
    ...
    def gen_view(self, table, model_name):
        ...
        view_file_all = output_dir + '/views/' + table + '_all.html'
        if os.path.exists(view_dir) is False:
            os.makedirs(view_dir)
        from model import *
